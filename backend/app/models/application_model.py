...
class Application(BaseModel):
    ...
    technicalSummary: Optional[str] = None  # AI-generated technical due-diligence summary
    legalSummary: Optional[str] = None  # AI-generated legal due-diligence summary
    marketSummary: Optional[str] = None  # AI-generated market due-diligence summary
    financialSummary: Optional[str] = None  # AI-generated financial due-diligence summary
    overallSummary: Optional[str] = None  # AI-generated overall due-diligence summary
